...
static const OptionRowDef g_optionRows[OPT_CATEGORIES][OPT_MAX_ROWS] = {
    ...
    },
    {
        ...
        { 0,          "Beautiful Skies", {"Off", "On", "Fancy"}, 3, 2 },
...
static void optionsApply() {
    ...
    g_fancySkies  = g_optionValueIdx[CAT_GRAPHICS][ROW_FANCYSKIES];
